...
async function main() {
    ...
    let rentInfo1 = await rentingInfo.create("12/11/2018", "12/15/2018", false, "PFA", "O", 5*car3.price, (user16._id).toString(), (car3._id).toString());
    ...
    let rentInfo3 = await rentingInfo.create("1/13/2018", "1/17/2018", false, "A", "O", 5*car11.price, (user20._id).toString(), (car10._id).toString());
    ...
    let rentInfo7 = await rentingInfo.create("2/25/2020", "2/27/2020", true, "R", "O", 2*car15.price, (user25._id).toString(), (car15._id).toString());
    ...
    let rentInfo8 = await rentingInfo.create("5/15/2020", "5/17/2020", true, "A", "O", 2*car15.price, (user20._id).toString(), (car15._id).toString());
    ...
    let rentInfo9 = await rentingInfo.create("6/15/2020", "6/17/2020", true, "A", "O", 2*car15.price, (user19._id).toString(), (car15._id).toString());
    ...
    let rentInfo11 = await rentingInfo.create("7/15/2019", "7/15/2019", true, "R", "O", 10*car12.price, (user18._id).toString(), (car12._id).toString());
    ...
    let rentInfo13 = await rentingInfo.create("7/15/2018", "7/25/2018", true, "A", "O", 10*car16.price, (user20._id).toString(), (car14._id).toString());
    ...
    let rentInfo15 = await rentingInfo.create("7/15/2018", "7/23/2018", false, "A", "O", 8*car20.price, (user20._id).toString(), (car14._id).toString());
    ...
    let rentInfo17 = await rentingInfo.create("7/10/2020", "7/25/2020", false, "PFA", "C", 15*car19.price, (user24._id).toString(), (car19._id).toString());
    ...
    let rentInfo18 = await rentingInfo.create("8/15/2018", "8/25/2018", true, "A", "O", 10*car12.price, (user19._id).toString(), (car12._id).toString());
    ...
    let rentInfo19 = await rentingInfo.create("7/20/2018", "7/25/2018", false, "R", "O", 5*car1.price, (user25._id).toString(), (car14._id).toString());
    ...
    let rentInfo22 = await rentingInfo.create("7/5/2020", "7/25/2020", true, "A", "O", 20*car1.price, (user16._id).toString(), (car1._id).toString());
